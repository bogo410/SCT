...
<div id="wrapper">
    ...
    <div id="content">
				...
				<body>
					<%
						Dipendente admin = Dipendente.getAdmin();
					%>
			
					<h2>Contatti del Responsabile: </h2>
					<h3>Nome e Cognome: &nbsp;&nbsp;<%=admin.getNome()%> <%=admin.getCognome()%></h3>
					<h3>e-Mail: &nbsp;&nbsp;<%=admin.getEmail()%></h3>
					<h3>Numero di Telefono: &nbsp;&nbsp;<%=admin.getNumTelefono()%></h3>
					<br>
				</body>	
